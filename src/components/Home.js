...
export default function Home() {
    ...
    return (
        <div className="bg-black-100 font-jakarta bg-full overflow-hidden text-white-100">
            ...
            <section className="lg:px-20 px-5 relative z-20">
            ...
            <section id='about' className="lg:px-20 px-5 relative z-20">
                <div className='container mx-auto'>
            ...
            <section id='tokenomics' className="lg:px-20 px-5 lg:pb-20 py-6 relative z-20">
                <div className='container mx-auto'>
            ...
            {/* roadmap section */}
            <section id='roadmap' className="lg:px-20 px-5 lg:py-20 py-6 relative z-20">
                <div className='container mx-auto'>
                    ...
                    <div className='lg:block hidden'>
                        ...
                        <div className='relative z-20 flex justify-between items-start gap-x-5 -translate-y-14'>
